...
_PREDEFINED_THEMES = [
    ...
    {"name": "반도체", "category": "반도체", "keywords": ["반도체", "메모리", "파운드리"],
     "naver_aliases": ["반도체 대표주", "반도체 장비", "반도체 재료", "반도체 대표주(생산)"]},
    {"name": "K-방산", "category": "방위산업", "keywords": ["방산", "무기", "수출"],
     "naver_aliases": ["방위산업", "방산", "방위산업/전쟁 및 테러"]},
    {"name": "바이오", "category": "헬스케어", "keywords": ["신약", "임상", "바이오텍"],
     "naver_aliases": ["바이오", "바이오시밀러", "바이오시밀러(복제 바이오의약품)"]},
    {"name": "로봇", "category": "신성장", "keywords": ["로봇", "자동화", "휴머노이드"],
     "naver_aliases": ["로봇", "휴머노이드", "피지컬 AI", "로봇(산업용/협동로봇 등)",
    ...
    {"name": "수소", "category": "에너지", "keywords": ["수소", "연료전지", "그린수소"],
     "naver_aliases": ["수소에너지", "수소차", "고체산화물 연료전지(SOFC)"]},
    ...
    {"name": "게임", "category": "IT서비스", "keywords": ["게임", "모바일게임", "e스포츠"],
     "naver_aliases": ["게임", "모바일게임", "모바일게임(스마트폰)"]},
...
_CATEGORY_KEYWORDS = [
    ...
    ("산업재", ["조선", "해운", "건설", "철강", "화학", "자동차부품", "골판지", "아스콘", "페인트",
              "제지", "윤활유", "사료", "수산", "육계", "콩", "대두"]),
    # 금융: 산업재 뒤에 배치 → IT/SW(핀테크/STO/블록체인)는 이미 상위에서 매칭되므로 영향 없음
    # 자동화기기 → 금융자동화기기로 좁혀 산업 자동화(공장자동화 등) 오분류 방지
    ("금융", ["보험", "금융", "증권", "은행", "리츠", "REITs", "SPAC",
             "기업인수목적회사", "금융자동화기기", "디지털화폐"]),
]
