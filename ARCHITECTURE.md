...
- `selector.py`: Top N 테마 선정
- `theme_rotator.py`: 2주 단위 테마 로테이션 (v2.0)
...
| TAKE_PROFIT_1 | 0.10 | 1차 익절률 (+10%) |
| TAKE_PROFIT_2 | 0.15 | 2차 익절률 (+15%) |
| TAKE_PROFIT_3 | 0.20 | 3차 익절률 (+20%) |
| TRAILING_STOP_PERCENT | 0.05 | 트레일링 스탑 (최고가 -5%) |
...
| 설정 | 기본값 | 설명 |
|------|--------|------|
| THEME_REVIEW_DAYS | 14 | 테마 재평가 주기 |
